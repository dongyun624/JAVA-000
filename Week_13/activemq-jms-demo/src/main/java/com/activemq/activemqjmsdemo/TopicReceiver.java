    ...
    public static void receiver() throws JMSException {
        ...
        consumer1.setMessageListener(new MessageListener() {
            ...
            public void onMessage(Message msg) {
                try {
                    ...
                    System.out.println("topic consumer1 收到消息： "+message.getText());
                    session.commit();
        ...
        consumer2.setMessageListener(new MessageListener() {
            ...
            public void onMessage(Message msg) {
                try {
                    TextMessage message = (TextMessage)msg ;
                    System.out.println("topic consumer2 收到消息： "+message.getText());
                    session.commit();
                } catch (JMSException e) {
                    e.printStackTrace();
                }
        ...
        consumer3.setMessageListener(new MessageListener() {
            ...
            public void onMessage(Message msg) {
                try {
                    TextMessage message = (TextMessage)msg ;
                    System.out.println("topic consumer3 收到消息： "+message.getText());
                    session.commit();
                } catch (JMSException e) {
                    e.printStackTrace();
                }
